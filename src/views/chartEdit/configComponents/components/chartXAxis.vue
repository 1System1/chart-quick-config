    ...
    <el-collapse-item title="X轴" name="xAxis">
        <div class="config-item">
            <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.show">
            ...
            <!-- <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.type">
            ...
            <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.axisLine.show">
                    <el-radio :label="true">显示</el-radio>
                    <el-radio :label="false">隐藏</el-radio>
                </el-radio-group>
            </div>
            <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.axisTick.show">
                    <el-radio :label="true">显示</el-radio>
                    <el-radio :label="false">隐藏</el-radio>
                </el-radio-group>
            </div>
            <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.splitLine.show">
                    <el-radio :label="true">显示</el-radio>
                    <el-radio :label="false">隐藏</el-radio>
                </el-radio-group>
            </div>
            <div class="config-item-row">
                ...
                <el-radio-group v-model="xAxis.axisLabel.show">
                    <el-radio :label="true">显示</el-radio>
                    <el-radio :label="false">隐藏</el-radio>
                </el-radio-group>
            </div>
            <div class="config-item-row">
                ...
                <el-select v-model="xAxis.axisLabel.rotate" placeholder="标签旋转角度" filterable allow-create clearable>
        ...
        <div class="confirm">
            <el-button type="primary" @click="handleChangeXAxis">运行</el-button>
        </div>
    </el-collapse-item>
</template>
<script>
    ...
    export default defineComponent({
        ...
        setup(props, { emit }) {
            ...
            // 去除 undefined 字段
            const getConfig = () => {
                return JSON.parse(JSON.stringify(state.xAxis));
            };
            const handleChangeXAxis = () => {
                emit('handleChangeXAxis', { xAxis: getConfig() });
            };
            return {
                ...toRefs(state),
                handleChangeXAxis,
